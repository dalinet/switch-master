<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <meta property="og:title" content="CC Switch"></meta>
</head>
    ...
    <table class="border" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #e9e9e9;Margin-left: auto;Margin-right: auto" width="602">
                                ...
                                <tr>
                                    <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                                        ...
                                        <div class="image" style="font-size: 12px;Margin-bottom: 24px;mso-line-height-rule: at-least;color: #565656;font-family: Georgia,serif" align="center">
                                            <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px" src="{{ url('/img/email-header.jpg') }}" alt="" width="600" height="120">
                                        </div>
                                                ...
                                                <tr>
                                                    <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                                                        ...
                                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
                                                            ...
                                                            {{ Lang::get('credentialsEmail.welcome', array('name'=> $name) ) }}
                                                            </strong>
                                                        </p>
                                                        <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
                                                            <strong style="font-weight: bold">
                                                            {{ Lang::get( 'credentialsEmail.msg' ) }}
                                                            </strong>
                                                        </p>
                                                        <ul style="Margin-top: 0;padding-left: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-left: 18px;Margin-bottom: 24px">
                                                            <li style="Margin-top: 0;padding-left: 0">
                                                                <strong style="font-weight: bold">{{ Lang::get('credentialsEmail.user') }}</strong>{{{$username}}}
                                                            </li>
                                                            <li style="Margin-top: 0;padding-left: 0"><strong style="font-weight: bold">{{ Lang::get('credentialsEmail.password') }}</strong> {{{$password}}}</li>
                                                        </ul>
        ...
        <table class="border" style="border-collapse: collapse;border-spacing: 0;font-size: 1px;line-height: 1px;background-color: #e9e9e9;Margin-left: auto;Margin-right: auto" width="602">
            ...
            <table class="centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto">
                <tbody>
                    <tr>
                        <td class="border" style="padding: 0;vertical-align: top;font-size: 1px;line-height: 1px;background-color: #e9e9e9;width: 1px">
                            &#8203;
                        </td>
                        <td style="padding: 0;vertical-align: top">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="column" style="padding: 0;vertical-align: top;text-align: left">
                                            ...
                                            <div class="image" style="font-size: 12px;Margin-bottom: 0px;mso-line-height-rule: at-least;color: #565656;font-family: Georgia,serif" align="center">
                                                <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top gnd-corner-image-bottom" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px" src="{{ url('/img/email-footer.jpg') }}" alt="" width="600" height="64">
                                            </div>
                    ...
                    <tr>
                        <td style="padding: 0;vertical-align: top">
                            <table style="border-collapse: collapse;border-spacing: 0">
                                <tbody>
                                    <tr>
                                        <td class="address" style="padding: 0;vertical-align: top;width: 600px;padding-top: 12px;padding-bottom: 64px">
                                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                                                <tbody>
                                                    <tr>
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;word-break: break-word;word-wrap: break-word;text-align: left;font-size: 12px;line-height: 20px;color: #444;font-family: Georgia,serif">
                                                            <div>
